            ...
            <div class="col-md-4">
                ...
                <form action=" edit.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="department" name="department" value="" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="activity" rows="3" name="activity" required><?php echo $row['activity']; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="department">Additional Information</label>
                        <textarea class="form-control" id="addinfo" rows="3" name="addinfo"><?php echo $row['additional_info']; ?></textarea>
                    </div>
                    <div class="form-group">
